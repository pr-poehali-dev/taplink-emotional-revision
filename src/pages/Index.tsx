      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-16">
            ...
            {[
              {
                ...
                price: "от 5000 ₽",
                desc: "Глубокая проработка тревоги, страхов, травм, самооценки. Освобождение от прошлого и обретение себя.",
                benefits: ["Снятие тревоги и панических атак", "Проработка детских травм", "Повышение самооценки"]
              },
              {
                icon: "Users",
                title: "Парная терапия",
                price: "от 7000 ₽",
                desc: "Восстановление близости, решение конфликтов, выход из кризиса. Вы вновь услышите друг друга.",
                benefits: ["Восстановление близости", "Решение конфликтов", "Новый уровень отношений"]
              },
              {
                icon: "GraduationCap",
                title: "Обучение методу '4 ключа'",
                price: "индивидуально",
                desc: "Для психологов и коллег. Авторская программа с супервизией и сертификацией.",
                benefits: ["Сертификация", "Супервизия", "Поддержка сообщества"]
              },
              {
                icon: "Video",
        ...
        <section className="text-center space-y-6 pb-12 animate-fade-in">
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <p className="mt-2">© 2024 Александра Петрова. Все права защищены.</p>
          </div>
        </section>
